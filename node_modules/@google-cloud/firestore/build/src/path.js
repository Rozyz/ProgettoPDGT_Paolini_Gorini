...
class FieldPath extends Path {
     ...
     */
    constructor(...segments) {
        validate_1.validateMinNumberOfArguments('FieldPath', arguments, 1);
        const elements = Array.isArray(segments[0]) ?
            segments[0] :
            segments;
        for (let i = 0; i < elements.length; ++i) {
            validate_1.validateString(i, elements[i]);
...
function validateFieldPath(arg, fieldPath) {
    ...
    if (fieldPath === undefined) {
        throw new Error(validate_1.invalidArgumentMessage(arg, 'field path') +
