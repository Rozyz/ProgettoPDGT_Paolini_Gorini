    ...
    onSnapshot(onNext, onError) {
        ...
        const initStream = () => {
            this._backoff.backoffAndWait().then(() => __awaiter(this, void 0, void 0, function* () {
                ...
                request.database = yield this._firestore.formattedName;
                request.addTarget = yield this.getTarget(resumeToken);
...
class DocumentWatch extends Watch {
    ...
    getTarget(resumeToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const formattedName = yield this.ref.formattedName;
            return {
                documents: {
...
class QueryWatch extends Watch {
    ...
    getTarget(resumeToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = yield this.query.toProto();
